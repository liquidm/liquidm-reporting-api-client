...
describe MadvertiseReporting::Client do
  ...
  it 'returns response on 200' do
    ...
    stub_request(:get, "http://api_token:@app.madvertise.de/visual_reports.json?").
  ...
  it 'raises on missing api token' do
    expect{ MadvertiseReporting::Client.new(nil) }.to raise_error
  end
